  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Demo Dashboard</h1>
          <p className="text-sm text-slate-500 mt-1">Compliance officer view — all shipments across exporters</p>
        </div>
                ...
                filtered.map((s) => {
                  ...
                  return (
                    <tr key={s.shipmentId} className="hover:bg-slate-50 transition">
                      ...
                      <td className="px-4 py-3">
                        <Link
                          href={`/demo/shipment/${s.shipmentId}`}
                          className="text-xs font-semibold text-[#111D6F] hover:text-[#F7911E] transition"
                        >
                          View Detail →
                        </Link>
                      </td>
